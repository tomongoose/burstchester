...
| 본 plan 외 | `vitest 단일화` (Node native test → vitest 마이그레이션) | MEDIUM | 350줄 7파일 수동 변환 — 별도 plan | ✅ **resolved** (`test-runner-unification-plan.md` 2026-05-06 완료 — 7 파일 22 cases 변환, `npm test = vitest run` 단일화, build 의존 제거) |
